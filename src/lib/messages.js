...
export const introMessageMobile = [
  ...
  "+-----------------------------------+",
  "",
  "Welcome to TantoDeFi's web3VM!",
  "A DeFi-focused development environment.",
  "",
...
export const introMessage = [
  ...
  "💜 Farcaster: https://farcaster.xyz/tantodefi",
